//+------------------------------------------------------------------+
//|                              GridBalancedTradingV2.mq5           |
//|                       EA Grid Trading với cân bằng lưới tự động  |
//+------------------------------------------------------------------+
#property copyright "Grid Balanced Trading"
#property version   "2.00"
#property description "Grid Trading EA với hệ thống cân bằng lưới tự động - V2"
...
input string CommentOrder = "Grid Balanced V2"; // Comment cho lệnh
...
int OnInit()
{
   ...
   Print("========================================");
   Print("Grid Balanced Trading EA V2 đã khởi động");
...
{
   Print("Grid Balanced Trading EA V2 đã dừng. Reason: ", reason);
}
